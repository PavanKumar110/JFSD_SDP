...
<head>
    ...
    <title>VEGE FOODS India PDF</title>
...
<%HttpSession h1=request.getSession(false);%>
  <div class="headerSection">
    ...
    <div class="invoiceDetails">
      ...
      <p>
        <%out.println(h1.getAttribute("sdate"));%>
      </p>
    </div>
  </div>
  ...
  <div class="headerSection">
    ...
    <div>
      <h3>Recepit to</h3>
      <p>
        <b><%out.println(h1.getAttribute("sname"));%></b>
        <br />
       <%out.println(h1.getAttribute("slocation"));%>
        <br />
        <%out.println(h1.getAttribute("smobile"));%>
        <br />
        <a href="<%out.println(h1.getAttribute("semail"));%>">
           <%out.println(h1.getAttribute("semail"));%>
        </a>
        <br />
...
<main>
  <table>
    ...
    <tbody>
      <tr>
        <td>
          <b><%out.println(h1.getAttribute("stype"));%></b>
          <br />
          <%out.println(h1.getAttribute("scomments"));%>
        </td>
        <td>
          <%out.println(h1.getAttribute("sdepth"));%>
        </td>
        <td>
           <%out.println(h1.getAttribute("sorganic"));%>
        </td>
        <td>
          <%out.println(h1.getAttribute("stexture"));%>
        </td>
          <td>
          <%out.println(h1.getAttribute("scrop"));%>
        </td>
        <td>
          <%out.println(h1.getAttribute("spcrop"));%>
        </td>
        <td>
          <%out.println(h1.getAttribute("sfertilizer"));%>
        </td>
        <td>
          <%out.println(h1.getAttribute("sirrigation"));%>
        </td>
      </tr>
...
<aside>
  ...
  <div>
    <div>
      <b>All Rights Reseved By VEGE FOODSIndia ©</b>
      <p>
...
<a  href="home"  style="padding:15px; margin:20px;background-color:green;border-radius:34px;margin-top:80px; color:#fff;">Home <i class="fa-solid fa-house"></i></a>
...
<script>
    ...
    const options = {
      margin: 0.001,
      filename: 'SoilReceiptVEGE FOODS.pdf',
      image: { 
        type: 'jpeg', 
        quality:1000
      },
