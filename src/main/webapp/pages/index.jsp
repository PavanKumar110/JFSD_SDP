...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        <a href="index.html" class="navbar-brand d-flex d-lg-none">
            <h1 class="m-0 display-4 text-secondary"><span class="text-white">VEGE FOODS</span>India</h1>
        </a>
...
<div class="floating-container zoom-in-out-box">
  <a href="stutrain"><div class="floating-button"><h3 style="color: white;">Student Corner<h6 style="color: blue;">click here</h6></h3></div></a>
  </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item" >
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Welcome</h3>
                            <h1 class="display-1 text-white mb-md-4">Be the Part of VEGE FOODSIndia.</h1>
            ...
            <div class="row gx-0">
                ...
                <div class="col-md-6" >
                    <div class="bg-secondary bg-fruitfarm d-flex flex-column justify-content-center p-5" style="height: 300px;">
                        ...
                        <p class="text-white">"At VEGE FOODS, we recognize the crucial role that weather conditions play in the success of farming. We understand that farmers need accurate and timely information to make informed decisions for their crops and livestock.</p>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-4">At VEGE FOODS, we are dedicated to providing a comprehensive suite of services designed to empower farmers and agricultural enthusiasts with the knowledge, resources, and support they need for successful and sustainable farming practices. </p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                       ...
                       <i class="fa-solid fa-magnifying-glass-chart display-1 text-primary mb-3"></i>
                        <h4>Soil Analysis</h4>
                        <p class="mb-0">VEGE FOODS's Soil Analysis Service is your first step towards cultivating a thriving and sustainable agricultural venture.</p>
                    </div>
                </div>
               <div class="col-lg-4 col-md-6" >
                    ...
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                       <i class="fa-solid fa-cart-shopping display-1 text-primary mb-3"></i>
                        <h4>Quick enquiry</h4>
                        <p class="mb-0">These quick inquiry services are designed to offer users immediate and valuable information related to their specific needs in the areas of crops, fertilizers, vegetables, seeds, and fruits on the VEGE FOODS platform.</p>
                    </div>
                ...
                <div class="col-lg-4 col-md-6" >
                    ...
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                       <i  class="fa-solid fa-cloud-moon-rain display-1 text-primary mb-3"></i>
                        ...
                        <p class="mb-0">At VEGE FOODS, we understand the pivotal role that weather conditions play in successful farming.,Access real-time weather information, including temperature, humidity  and more.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" >
                    ...
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                        ...
                        <p class="mb-0">At VEGE FOODS, we recognize the importance of continuous learning in the ever-evolving field of agriculture. Engage in interactive workshops and webinars covering a range of agricultural topics.</p>
                    </div>
                   ...
                   <a href="stutrain">
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                      <i  class="fa-solid fa-graduation-cap display-1 text-primary mb-3"></i>
                        ...
                        <p class="mb-0"> At  VEGE FOODS Agro Student Training provides a distinctive platform for you to share your agricultural knowledge, offer specialized courses, and connect directly with aspiring agri-entrepreneurs and students. </p>
                    </div></a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-3">
                    ...
                    <div class="text-white">
                        ...
                        <p class="mb-0">VEGE FOODS has been honored with the prestigious Agricultural Innovation Excellence Award.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/teja.png" alt="" style="height: 400px; " >
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">pavan</h4>
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/teja.png" alt="" style="height: 400px;">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Edara Saiteja </h4>
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/teja.png" alt="" style="height: 400px;">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Kurra Deepak</h4>
