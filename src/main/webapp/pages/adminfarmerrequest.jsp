...
<head> 
	...
	<meta name="viewport"
		content="width=device-width, 
				initial-scale=1.0"> 
	<title>Admin Farmer Training Request</title> 
	<link rel="stylesheet"
...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210182541/Untitled-design-(30).png"
		...
		<label style="margin-left:20px; font-size:15px" ><i class="fa-regular fa-calendar"></i>&nbsp;Filter Daily,Weekly,Monthly</label>
		 <form action="reportgetfarmer" method="get">
		...
		<div class="main"> 
		   ...
		   <div class="report-container"> 
				<div class="report-header"> 
					<h1 class="recent-Articles" style="color:#16697a;">Farmer Training Request &nbsp; <i class="fa-solid fa-tractor"></i></h1> 
