...
<title>VEGE FOODS India Homepage</title>
...
<script>
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/teja.png" alt="" style="height: 400px;s " >
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">saiteja </h4>
    ...
    <img class="img-fluid fit-image" src="blogimg/${e.blogimg}" alt="">
...
<style>
    .fit-image {
        ...
        transform: rotate(0deg); /* Ensures the image is straight */
    }
</style>
