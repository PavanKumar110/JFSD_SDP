...
<head> 
	...
	<meta name="viewport"
		content="width=device-width, 
				initial-scale=1.0"> 
	<title>Admin Registred Agroagency</title> 
	<link rel="stylesheet"
    ...
    %>
			...
			<div class="report-container"> 
				<div class="report-header"> 
					<h1 class="recent-Articles" style="color:orange;">Registered Agroagency &nbsp;<i class="fa-regular fa-registered"></i></h1> 
        ...
        <c:when test="${username.equals('admin')}">
            <a href="removeagro/${e.id}">
                <button type="button" style="background-color: red; width: 80px;" class="demo">
                    Remove Access<i class="fa-solid fa-xmark"></i>
                </button>
            </a>
        </c:when>
        
        <c:otherwise>
            <!-- Button is not shown for "admin" -->
            <button>Permission Denied</button>
        </c:otherwise>
    </c:choose>
