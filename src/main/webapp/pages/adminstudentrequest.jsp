...
<head> 
	...
	<meta name="viewport"
		content="width=device-width, 
				initial-scale=1.0"> 
	<title> Admin Student Training Request</title> 
	<link rel="stylesheet"
...
<body> 
	...
	<header> 
		...
		<div class="logosec"> 
            <div class="logo">VEGE FOODSIndia</div> 
            <img src= 
"https://media.geeksforgeeks.org/wp-content/uploads/20221210182541/Untitled-design-(30).png"
		...
		<div class="searchbar"> 
			<input type="text"  placeholder="Search by Location or Training Type" id="searchInput" oninput="searchTable()" style="width:340px;"> 
			<div class="searchbtn"> 
				<i class="fa-solid fa-magnifying-glass"></i>
			</div> 
		</div> 
		<label style="margin-left:20px; font-size:15px" ><i class="fa-regular fa-calendar"></i>&nbsp;Filter Daily,Weekly,Monthly</label>
		 <form action="reportgetstudent" method="get">
		...
		<div class="main"> 
		   ...
		   <div class="report-container"> 
				<div class="report-header"> 
					<h1 class="recent-Articles" style="color:#0582ca;">Student Training Request &nbsp; <i class="fa-solid fa-graduation-cap"></i></h1> 
    ...
    function searchTable() {
        ...
        for (i = 0; i < tr.length; i++) {
            ...
            tdCategory = tr[i].getElementsByTagName("td")[3]; // Assuming the category is in the third column
            tdOurPrice = tr[i].getElementsByTagName("td")[5]; // Assuming the "Our Price" column is the fifth column
