    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="agro"><img src="img/logo1.png" alt="" style="margin: 0px;  width: 180px; margin: 10px; margin-right:850px; border-radius: 15px;"></a>
...
<!-- Markee start -->
    <div class="marquee-container">
        <marquee class="marquee">
            VEGE FOODS India AgroAgency Registration Portal - Register your AgroAgency With Us,Submit Your Details Now , 100% Online Process. | For Any Query Contact our HelplineNumber.
        </marquee>
    </div>
                ...
                <div class="carousel-item active" >
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            ...
                            <p class="text-white" style="font-size: 30px;">VEGE FOODS India is a web-based open discussion portal. </p>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">98344</p>
                            </div>
